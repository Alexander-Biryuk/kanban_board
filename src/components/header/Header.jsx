          ...
          {showDropdown && (
            <>
              ...
              <div className={styles.dropdown_menu}>
                <Link to='profile' className={styles.menu_item} onClick={() => setShowDropdown(false)}>Profile</Link>
                <Link to='/' className={styles.menu_item} onClick={() => setShowDropdown(false)}>Log Out</Link>
              </div>
            </>
          )}
